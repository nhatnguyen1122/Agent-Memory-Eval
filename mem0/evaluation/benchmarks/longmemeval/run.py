...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Custom base URL for OpenAI-compatible answerer endpoints",
    )
    parser.add_argument(
        "--judge-base-url", default=None,
        help="Custom base URL for OpenAI-compatible judge endpoints (defaults to --base-url)",
    )
    parser.add_argument(
        "--api-key", default=None,
        help="Explicit API key for the answerer provider",
    )
    parser.add_argument(
        "--judge-api-key", default=None,
        help="Explicit API key for the judge provider (defaults to --api-key)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--memory-backend",
        default="mem0_graph",
        choices=["mem0", "mem0_graph", "a_mem", "memorybank", "mem0_server"],
        help="Memory system under test. Use mem0_server for the original benchmark server flow.",
    )
    parser.add_argument(
        "--memory-api-key", default=None,
        help="API key for memory-system LLM calls (Mem0 direct / A-mem).",
    )
    parser.add_argument(
        "--memory-base-url", default=None,
        help="OpenAI-compatible base URL for memory-system LLM/embedder calls.",
    )
    parser.add_argument(
        "--memory-model", default=None,
        help="Model used internally by the memory backend when applicable.",
    )
    parser.add_argument(
        "--memory-embedder-model", default=None,
